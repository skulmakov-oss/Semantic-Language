...
pub mod semcode_format {
    pub use crate::local_format::{
        ...
        CAP_TEXT_VALUES, CAP_CLOSURE_VALUES, HEADER_V0, HEADER_V1, HEADER_V2, HEADER_V3,
        HEADER_V4, HEADER_V5, HEADER_V6, HEADER_V7, HEADER_V8, HEADER_V9, HEADER_V10,
        HEADER_V11, MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4, MAGIC5, MAGIC6, MAGIC7, MAGIC8,
        MAGIC9, MAGIC10, MAGIC11, OWNERSHIP_EVENT_KIND_BORROW, OWNERSHIP_EVENT_KIND_WRITE,
