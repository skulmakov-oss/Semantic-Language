...
pub mod semcode_format {
    pub use crate::local_format::{
        ...
        CAP_EVENT_POST, CAP_FX_MATH, CAP_FX_VALUES, CAP_GATE_SURFACE, CAP_STATE_QUERY,
        CAP_STATE_UPDATE, HEADER_V0, HEADER_V1, HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5,
        HEADER_V6, MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4, MAGIC5, MAGIC6,
    };
}
