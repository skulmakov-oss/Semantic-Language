...
pub use sm_ir::semcode_format::{
    ...
    CAP_STATE_UPDATE, CAP_TEXT_VALUES, HEADER_V0, HEADER_V1, HEADER_V2, HEADER_V3, HEADER_V4,
    HEADER_V5, HEADER_V6, HEADER_V7, HEADER_V8, MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4,
    MAGIC5, MAGIC6, MAGIC7, MAGIC8,
};
#[cfg(feature = "std")]
pub use sm_ir::{
