...
pub use sm_ir::semcode_format::{
    ...
    SemcodeFormatError, SemcodeHeaderSpec, CAP_DEBUG_SYMBOLS, CAP_F64_MATH, CAP_FX_MATH,
    CAP_FX_VALUES, CAP_GATE_SURFACE, CAP_STATE_QUERY, CAP_STATE_UPDATE, HEADER_V0, HEADER_V1,
    HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5, MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4,
    MAGIC5,
};
#[cfg(feature = "std")]
pub use sm_ir::{
