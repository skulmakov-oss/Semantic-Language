...
pub use sm_ir::semcode_format::{
    ...
    SemcodeFormatError, SemcodeHeaderSpec, CAP_DEBUG_SYMBOLS, CAP_EVENT_POST, CAP_F64_MATH,
    CAP_FX_MATH, CAP_FX_VALUES, CAP_GATE_SURFACE, CAP_STATE_QUERY, CAP_STATE_UPDATE, HEADER_V0,
    HEADER_V1, HEADER_V2, HEADER_V3, HEADER_V4, HEADER_V5, HEADER_V6, MAGIC0, MAGIC1, MAGIC2,
