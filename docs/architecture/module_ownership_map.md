...
- `ton618_core` and `src/bin/support/**` are retained compatibility shims, not canonical public owners;
- `ton618-core` is a retained compatibility-named primitive crate, not a second owner for `sm-*` public contracts;
