...
pub mod semcode_format {
    pub use sm_emit::{
        ...
        CAP_STATE_QUERY, CAP_STATE_UPDATE, HEADER_V0, HEADER_V1, HEADER_V2, HEADER_V3, HEADER_V4,
        HEADER_V5, HEADER_V6, HEADER_V7, MAGIC0, MAGIC1, MAGIC2, MAGIC3, MAGIC4, MAGIC5, MAGIC6,
        MAGIC7,
    };
}
#[cfg(feature = "std")]
